defmodule ChirpWeb.PostLiveTest do
  ...
  @create_attrs %{body: "some body", username: "some username", likes: 42, reposts: 42}
  @update_attrs %{body: "some updated body", username: "some updated username", likes: 43, reposts: 43}
  @invalid_attrs %{body: nil, username: nil, likes: nil, reposts: nil}
